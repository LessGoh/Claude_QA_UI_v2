    ...
    **Новые возможности:**
    ...
    if st.session_state.index_manager:
        ...
        with col1:
            ...
            personal_index = f"pdf-qa-personal-{st.session_state.username}"
...
def render_index_management_page():
    ...
    current_index = st.session_state.current_index or f"pdf-qa-personal-{st.session_state.username}"
    index_type = "Личный" if current_index.endswith(f"-{st.session_state.username}") else "Общий"
